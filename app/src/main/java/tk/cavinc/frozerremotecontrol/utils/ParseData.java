    ...
    public void parse(String data){
        ...
        if (matcher.find()) {
            ...
            try {
                ...
                control.setRemoteControlTemperature(Double.valueOf(dt[1]));
            } catch (Exception e) {
                //control.setControlTemperature(0);
                control.setRemoteControlTemperature(0);
            }
            mDataManager.setDeviceControl(control);
        }
        ...
        if (matcher.find()){
            ...
            try {
                ...
                control.setRemote_heater_time_on(Integer.valueOf(dt[1].trim()));
            } catch (Exception e){
        ...
        if (matcher.find()){
            ...
            try {
                ...
                control.setRemote_heater_time_off(Integer.valueOf(dt[1].trim()));
            } catch (Exception e){
